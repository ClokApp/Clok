package com.kingfu.clok.navigation.navGraphBuilder.settings.settingsTheme
...
fun NavGraphBuilder.settingsThemeGraph(
    ...
    composable(
        route = Screen.SettingsTheme.route,
        enterTransition = {
            slideIntoContainer(
            ...
            content = { paddingValue ->
                ...
                Column(
                    ...
                    SettingsThemeScreen(
                        ...
                        saveAppTheme = {
                            settingsViewModel.saveAppTheme()
                        },
                        theme = theme
                    )
                }
