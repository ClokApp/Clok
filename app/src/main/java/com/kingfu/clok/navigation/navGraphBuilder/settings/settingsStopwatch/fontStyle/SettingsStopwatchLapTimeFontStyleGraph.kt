...
import com.kingfu.clok.settings.settingsScreen.settingsStopwatchScreen.fontStyle.SettingsStopwatchLapTimeFontStyleScreen
import com.kingfu.clok.settings.viewModel.settingsViewModelStopwatch.SettingsViewModelStopwatch
import kotlin.math.abs

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@OptIn(ExperimentalMaterial3Api::class)
fun NavGraphBuilder.settingsStopwatchLapTimeFontStyleGraph(
    ...
    composable(
        route = Screen.SettingsStopwatchLapTimeFontStyle.route,
        enterTransition = {
            slideIntoContainer(
            ...
            content = { paddingValues ->
                ...
                Column(
                    ...
                    SettingsStopwatchLapTimeFontStyleScreen(
                        updateStopwatchLapTimeFontStyle = { string: String ->
                            settingsViewModelStopwatch.updateStopwatchLapTimeFontStyle(string = string)
                        },
                        saveStopwatchLapTimeFontStyle = {
                            settingsViewModelStopwatch.saveStopwatchLapTimeFontStyle()
                        },
                        stopwatchLapTimeFontStyle = settingsViewModelStopwatch.state.stopwatchLapTimeFontStyle
                    )
                }
            }
        )
