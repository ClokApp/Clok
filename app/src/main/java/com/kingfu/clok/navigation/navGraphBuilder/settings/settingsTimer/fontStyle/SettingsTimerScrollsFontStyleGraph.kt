...
import com.kingfu.clok.settings.settingsScreen.settingsTimerScreen.fontStyle.SettingsTimerScrollsFontStyleScreen
import com.kingfu.clok.settings.viewModel.settingsViewModelTimer.SettingsViewModelTimer
import kotlin.math.abs

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@OptIn(ExperimentalMaterial3Api::class)
fun NavGraphBuilder.settingsTimerScrollsFontStyleGraph(
    ...
    composable(
        route = Screen.SettingsTimerScrollsFontStyle.route,
        enterTransition = {
            slideIntoContainer(
            ...
            content = { paddingValues ->
                ...
                Column(
                    ...
                    SettingsTimerScrollsFontStyleScreen(
                        updateTimerScrollsFontStyle = { string: String ->
                            settingsViewModelTimer.updateTimerScrollsFontStyle(string = string)
                        },
                        saveTimerScrollsFontStyle = {
                            settingsViewModelTimer.saveTimerScrollsFontStyle()
                        },
                        timerScrollsFontStyle = settingsViewModelTimer.state.timerScrollsFontStyle
                    )
                }
            }
        )
