...
import com.kingfu.clok.settings.settingsScreen.settingsStopwatchScreen.fontStyle.SettingsStopwatchLabelFontStyleScreen
import com.kingfu.clok.settings.viewModel.settingsViewModelStopwatch.SettingsViewModelStopwatch
import kotlin.math.abs

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@OptIn(ExperimentalMaterial3Api::class)
fun NavGraphBuilder.settingsStopwatchLabelFontStyleGraph(
    ...
    composable(
        route = Screen.SettingsStopwatchLabelFontStyle.route,
        enterTransition = {
            slideIntoContainer(
            ...
            content = { paddingValues ->
                ...
                Column(
                    ...
                    SettingsStopwatchLabelFontStyleScreen(
                        updateStopwatchLabelFontStyle = { string: String ->
                            settingsViewModelStopwatch.updateStopwatchLabelFontStyle(string = string)
                        },
                        saveStopwatchLabelFontStyle = {
                            settingsViewModelStopwatch.saveStopwatchLabelFontStyle()
                        },
                        stopwatchLabelFontStyle = settingsViewModelStopwatch.state.stopwatchLabelFontStyle
                    )
                }
            }
        )
