...
import com.kingfu.clok.settings.settingsScreen.settingsTimerScreen.SettingsTimerProgressBarBackgroundEffectsScreen
import com.kingfu.clok.settings.viewModel.settingsViewModelTimer.SettingsViewModelTimer
import kotlin.math.abs

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@OptIn(ExperimentalMaterial3Api::class)
fun NavGraphBuilder.settingsTimerBackgroundEffectsGraph(
            ...
            content = { paddingValue ->
                ...
                Column(
                    ...
                    SettingsTimerProgressBarBackgroundEffectsScreen(
                        updateTimerBackgroundEffects = { string: String ->
                            settingsViewModelTimer.updateTimerBackgroundEffects(string = string)
                        },
                        saveTimerBackgroundEffects = {
                            settingsViewModelTimer.saveTimerBackgroundEffects()
                        },
                        timerBackgroundEffects = settingsViewModelTimer.state.timerProgressBarBackgroundEffect
                    )
                }
            }
        )
