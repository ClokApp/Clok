...
import com.kingfu.clok.settings.settingsScreen.settingsTimerScreen.SettingsTimerProgressBarBackgroundEffects
...
fun NavGraphBuilder.settingsTimerBackgroundEffectsGraph(
    ...
    composable(route = Screens.SettingsTimerProgressBarBackgroundEffects.route) {
        ...
        Scaffold(
            ...
            content = { paddingValue ->
                Box(modifier = Modifier.padding(paddingValues = paddingValue)) {
                    SettingsTimerProgressBarBackgroundEffects(vm = settingsViewModelTimer)
                }
            }
        )
    }
