...
fun NavGraphBuilder.settingsTimerFontStylesGraph(
    ...
    composable(
        route = Screen.SettingsTimerFontStyles.route,
        enterTransition = {
            slideIntoContainer(
                ...
                Column(
                    ...
                    SettingsTimerFontStylesScreen(
                        goToSettingsTimerTimeFontStyle = {
                            navController.navigate(route = Screen.SettingsTimerTimeFontStyle.route)
                        },
                        goToSettingsTimerScrollsFontStyle = {
                            navController.navigate(route = Screen.SettingsTimerScrollsFontStyle.route)
                        }
                    )
                }
            }
