            ...
            content = { paddingValue ->
                ...
                Column(
                    ...
                    SettingsStopwatchLabelStyle(
                        updateStopwatchLabelStyle = { string: String ->
                            settingsViewModelStopwatch.updateStopwatchLabelStyle(string = string)
                        },
                        saveStopwatchLabelStyle = { settingsViewModelStopwatch.saveStopwatchLabelStyle() },
                        stopwatchLabelStyle = settingsViewModelStopwatch.state.stopwatchLabelStyle
                    )
                }
            }
        )
