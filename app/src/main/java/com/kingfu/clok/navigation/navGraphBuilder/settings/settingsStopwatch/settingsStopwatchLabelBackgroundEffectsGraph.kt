...
import com.kingfu.clok.settings.settingsScreen.settingsStopwatchScreen.SettingsStopwatchLabelBackgroundEffectsScreen
            ...
            content = { paddingValue ->
                ...
                Column(
                    ...
                    SettingsStopwatchLabelBackgroundEffectsScreen(
                        updateStopwatchBackgroundEffect = { string: String ->
                            settingsViewModelStopwatch.updateStopwatchBackgroundEffect(string = string)
                        },
                        saveStopwatchBackgroundEffects = {
                            settingsViewModelStopwatch.saveStopwatchBackgroundEffects()
                        },
                        stopwatchBackgroundEffects = settingsViewModelStopwatch.state.stopwatchLabelBackgroundEffects
                    )
                }
            }
        )
