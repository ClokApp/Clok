...
@Composable
fun SettingsStopwatchTimeFontStyleScreen(
    updateStopwatchTimeFontStyle: (String) -> Unit,
    saveStopwatchTimeFontStyleSelectedOption: () -> Unit,
    ...
    OneUI(
        ...
        onClick = {
            updateStopwatchTimeFontStyle(default)
            saveStopwatchTimeFontStyleSelectedOption()
        },
        leftColumn = { MyRadioButton(selected = default == stopwatchTimeFontStyle) }
    )
    ...
    OneUI(
        ...
        onClick = {
            updateStopwatchTimeFontStyle(innerStroke)
            saveStopwatchTimeFontStyleSelectedOption()
        },
        leftColumn = { MyRadioButton(selected = innerStroke == stopwatchTimeFontStyle) }
    )
...
@Composable
fun CustomCardPreviewSettingsStopwatchTimeFontStyleScreen() {
    ClokTheme(
        dynamicColor = true,
        ...
        Column(modifier = Modifier.verticalScroll(state = rememberScrollState())) {
            SettingsStopwatchTimeFontStyleScreen(
                updateStopwatchTimeFontStyle = {},
                saveStopwatchTimeFontStyleSelectedOption = {},
                stopwatchTimeFontStyle = StopwatchFontStyleType.Default.name
            )
        }
    }
}
