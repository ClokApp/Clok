...
fun TextDisplayLarge(
    ...
    fontSize: TextUnit = typography.displayLarge.fontSize,
...
@Composable
fun TextBodyMediumAnnotatedString(
    annotatedString: AnnotatedString,
    modifier: Modifier = Modifier,
    color: Color = colorScheme.outline,
    fontSize: TextUnit = TextUnit.Unspecified,
...
@Composable
fun TextBodyMediumHeading(
    text: String,
    modifier: Modifier = Modifier,
    color: Color = colorScheme.onTertiaryContainer,
    fontSize: TextUnit = TextUnit.Unspecified,
    fontStyle: FontStyle? = null,
    ...
    Text(
        text = text,
        modifier = modifier.padding(start = 24.dp, end = 32.dp, top = 12.dp, bottom = 6.dp),
        color = color,
        fontSize = fontSize,
        fontStyle = fontStyle,
        fontWeight = fontWeight,
