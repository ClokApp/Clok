package com.kingfu.clok.viewModel.timerViewModel
...
class TimerViewModel(
    ...
    init {
        viewModelScope.launch {
            ...
            timerIsActive = timerPreferences.getTimerIsActive.first()
    ...
    private suspend fun timerUpdateStartAndEndRGB() {
    ...
    suspend fun saveTimerIsActive() {
        timerPreferences.setTimerIsActive(timerIsActive)
    }
